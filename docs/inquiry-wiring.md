...
This document describes the production boundary between the ServingStudio Agent,
conversation backend, Launcher, Rust Analyzer, and ServingStudio UI. It replaces the
...
| ServingStudio UI | Analyzer presentation, Agent shell, frozen citation rendering and click navigation | DSL parsing into targets or metric inference |
