...
export const METRIC_CAPTIONS: Record<MetricKey, string> = {
  ...
  backpressure: 'Pending scheduler-queue length over wall-clock time. Cluster and pool totals are stacked from their worker queues; the outline is the exact pointwise sum.',
};
